...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        scaleRate = a.getFloat(R.styleable.CircleImageView_scaleRate, 1);
        a.recycle();
        paint = new Paint();
        ...
        if (drawable != null) {
            ...
            if (scaleRate != 1){
                bitmap = Bitmap.createScaledBitmap(bitmap,
                        (int)(getWidth() * scaleRate),
                        (int)(getHeight() * scaleRate), true);
                Log.d(TAG, "onDraw: viewWidth = " + getWidth());
            ...
            Rect rectDest = new Rect(getPaddingLeft() , getPaddingTop(),
